      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col md:flex-row gap-12">
          <div className="md:w-1/2">
            <h2 className="text-3xl font-bold mb-6 text-engineer-darkgray relative inline-block">
              About Me
          ...
          <div className="md:w-1/2">
            <h3 className="text-2xl font-semibold mb-6 text-engineer-darkgray">Key Achievements</h3>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
                <div className="bg-engineer-red/10 p-3 rounded-full w-fit mb-4">
                  <Wrench className="h-6 w-6 text-engineer-red" />
                </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
                <div className="bg-engineer-red/10 p-3 rounded-full w-fit mb-4">
                  <Gauge className="h-6 w-6 text-engineer-red" />
                </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
                <div className="bg-engineer-red/10 p-3 rounded-full w-fit mb-4">
                  <Lightbulb className="h-6 w-6 text-engineer-red" />
                </div>
              ...
              <div className="bg-gray-50 p-6 rounded-lg border border-gray-100 hover:shadow-md transition-shadow">
                <div className="bg-engineer-red/10 p-3 rounded-full w-fit mb-4">
                  <BookOpen className="h-6 w-6 text-engineer-red" />
                </div>
